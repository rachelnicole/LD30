...
BasicGame.Game5.prototype = {

  preload: function () {

    this.load.image('background', 'assets/background5.png');
    this.load.image('p1', 'assets/p1d.png');
    this.load.image('p2', 'assets/p2d.png');
  ...
  update: function () {
    ...
    blackhole.angle++;
      ...
      blackhole.scale.setTo(Math.sin(this.game.time.now * 0.005) + 3);

...
BasicGame.Game4.prototype = {

  preload: function () {

    this.load.image('background', 'assets/background4.png');
    this.load.image('p1', 'assets/p1c.png');
    this.load.image('p2', 'assets/p2c.png');
  ...
  update: function () {
    ...
    blackhole.angle++;
      ...
      blackhole.scale.setTo(Math.sin(this.game.time.now * 0.004) + 3);
